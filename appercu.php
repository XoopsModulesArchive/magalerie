...
if ('' != $_POST['nom1']) {
    $message = htmlspecialchars($_POST['nom1'], ENT_QUOTES | ENT_HTML5);
}
if ('' != $_POST['email1']) {
    $message = htmlspecialchars($_POST['email1'], ENT_QUOTES | ENT_HTML5);
}
if ('' != $_POST['nom2']) {
    $message = htmlspecialchars($_POST['nom2'], ENT_QUOTES | ENT_HTML5);
}
if ('' != $_POST['email2']) {
    $message = htmlspecialchars($_POST['email2'], ENT_QUOTES | ENT_HTML5);
}
if ('' != $_POST['sujet']) {
    $message = htmlspecialchars($_POST['sujet'], ENT_QUOTES | ENT_HTML5);
}
