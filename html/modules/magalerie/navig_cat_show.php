...
if ($aktuell > 1) {
    echo '<td align="left" width="50"><a href="show.php?id=' . $img_ret . '">' . '<img src="images/back.gif" width="16" height="17" border="0" title="' . _PREC . '"></a></td>';
} else {
...
if ($aktuell < $menge) {
    echo '<td align="right" width="50"><a href="show.php?id=' . $img_next . '"><img src="images/suiv.gif" width="16" height="17" border="0" title="' . _SUIV . '"></a></td>';
} else {
    echo '<td align="center" width="50">&nbsp;</td>';
}
echo '</table>';
